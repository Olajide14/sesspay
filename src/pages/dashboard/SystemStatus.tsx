      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        <div className="py-4">
          ...
          <div className="bg-white shadow sm:rounded-lg">
            <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
              <h3 className="text-lg leading-6 font-medium text-gray-900">Incident History</h3>
              <p className="mt-1 text-sm text-gray-500">
                        ...
                        <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                          <div>
                            <p className="text-sm text-gray-500">
                              <span className="font-medium text-gray-900">API Degradation</span> - Some API requests were experiencing increased latency
                            </p>
                          </div>
                    ...
                    <div className="relative pb-8">
                      ...
                      <div className="relative flex space-x-3">
                        ...
                        <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                          <div>
                            <p className="text-sm text-gray-500">
                              <span className="font-medium text-gray-900">API Degradation Resolved</span> - The API latency issues have been resolved
                            </p>
                          </div>
                          <div className="text-right text-sm whitespace-nowrap text-gray-500">
                            <span>April 1, 2025</span>
                    ...
                    <div className="relative">
                      <div className="relative flex space-x-3">
                        ...
                        <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                          <div>
                            <p className="text-sm text-gray-500">
                              <span className="font-medium text-gray-900">Scheduled Maintenance</span> - System was down for scheduled maintenance
                            </p>
                          </div>
                          <div className="text-right text-sm whitespace-nowrap text-gray-500">
