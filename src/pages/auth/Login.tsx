...
import { Rocket, Lock, Mail, ArrowRight, Github } from 'lucide-react';
        ...
        <div className="bg-white py-8 px-4 shadow-xl shadow-gray-200/60 sm:rounded-xl sm:px-10 relative overflow-hidden">
          ...
          <form className="space-y-6 relative" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a href="/forgot-password" className="font-medium text-primary hover:text-primary-700 transition-colors">
            ...
            <div>
              <button
                type="submit"
                className="group relative w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors"
              >
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-500">
              ...
              <a href="/register" className="font-medium text-primary hover:text-primary-700 inline-flex items-center transition-colors">
